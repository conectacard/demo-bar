...
function renderGallery(cat) {
    ...
    if (cat === 'cat3' || cat === 'cat2') {
        ...
        if (cat === 'cat3') {
            ...
            videoContainer.innerHTML = `
                <a href="https://www.youtube.com/shorts/qhb9qEIiDNE" target="_blank" style="background: #b00; color: #fff; padding: 12px 25px; border-radius: 12px; text-decoration: none; font-weight: 900; font-size: 0.9rem;">
